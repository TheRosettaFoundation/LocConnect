...
<td style="width: 315px;"><input name="format" value="TEXT" type="radio"  /><?php print  BASE_PMUI_TEXT_INPUT;?><br/><input name="format" value="XLIFF" type="radio" checked/>  <?php print  BASE_PMUI_XLIFF_INPUT;?></td>
</tr>
<tr>
