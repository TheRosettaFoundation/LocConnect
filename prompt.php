...
<td style="width: 315px;"><input name="format" value="TEXT" type="radio"  /> Text file or text input <br/><input name="format" value="XLIFF" type="radio" checked/>  XLIFF file</td>
</tr>
<tr>
