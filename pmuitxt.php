...
<tr>
<td style="width: 202px;"><?php print  BASE_PMUI_ITS;?></td>
<td style="width: 315px;"><input name="its_validation" value="Yes" type="radio" checked />Yes <input name="its_validation" value="No" type="radio" />No</td>
</tr>
<tr>
