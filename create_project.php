...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="wrapper">
            <div id="content">
                <div id="header"> <h4 class="lang"><?php $i = 0;
        foreach ($languages as $code => $svrpath) {
            $i++;
            print '<a href="' . $svrpath . '/' . curPageName() . '" >' . $code . '</a>';
...
//upload resource
                        ...
                        if ($tmpName1) {
                            if (move_uploaded_file($tmpName1, $upload_path . $filename1)) {
                                $resID = sendResource($project_ID, 'lmc', 'domain:test', 'Test file', base64_encode($content1), $tmpName1);
