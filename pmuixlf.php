...
<tr>
	<td colspan="2" rowspan="1" style="width: 202px; text-align: center;"><hr/></td>
</tr>
<tr>
	<td colspan="2" rowspan="1" style="width: 202px; text-align: center;">Upload, select or create an LMC file from the previous LocConnect projects<br></td>
</tr>
<tr>
...
<tr>
 ...
 <td>
	<input type="text" name="lmcdesc" value="<?php if (BASE_DEF_VAL=='ON') print  date("d/m/Y");?>"/>
 </td>
</tr>
<tr>
	<td>
	Select previous LMC file:
	</td>
	<td>
	<select name="prevlmc">
...
<tr>
	<td colspan="2" rowspan="1" style="width: 202px; text-align: Left;">Create LMC file from previous LocConnect projects:<br></td>
</tr>
<tr>
 ...
 <table>
            <tr>
                <td>
                        Filter: <input type="text" id="box1Filter" size="15" /><button type="button" id="box1Clear">X</button><br />

                        <select id="box1View" multiple="multiple" style="height:100px;width:200px;">
						<?php
						 try
						{
						//open the database
                ...
                <td>
                    Filter: <input type="text" id="box2Filter" size="15" /><button type="button" id="box2Clear">X</button><br />
                    <select name="selectlmc[]" id="box2View" multiple="multiple" style="height:100px;width:200px;">
